...
class gui__welcome:
    ...
    def run(self):
        ...
        self.button__create_project = tkinter.Button(master=self.frame1, text="设置", height=4, width=10, bd=3)
        self.button__create_project.place(x=self.x_button + 2 * self.interval_button, y=self.y_button)
...
class gui__create_project:
    def __init__(self):
        ...
        self.label__packname = tkinter.Label(master=screen,text="追加包名称",font=font)
        self.label__packname.place(x=20,y=20)
        self.label__version = tkinter.Label(screen,text="游戏版本",font=font)
